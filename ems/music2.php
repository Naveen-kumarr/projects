...
body
     {
     background-image: url("http://www.xpertz.in/images/background-one.jpg");
...
<body>
	...
	<h1><center>YOUR MUSIC EVENT</center></h1>
	<center><h4>
<?php
...
if(isset($_POST['submit']))
{
 ...
 if(empty($mn))
	...
	{
		$msg="Please Enter Musical group name";
	}	
	else if(empty($cn))
	{
	...
	{
	mysql_query("insert into events(event_type,your_name,music_grp_name,contact_no,address,booking_date,created_date) VALUES('6','$mn','$mgn','$cn','$ar','$bkd','now()')");
...
<font color="black"><input type="text" name="muname" placeholder="Your name..." /> <br />
<font color="white">Musical Group Name<br />
<font color="black"><input type="text" name="musicg" placeholder="Group name..."/> <br />
<font color="white">Contact No<br />
<font color="black"><input type="text" name="cntc" placeholder="Your contact no..."/> <br />
<font color="white"><label for="area">Select event area</label><br />
