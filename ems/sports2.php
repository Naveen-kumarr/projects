...
if(isset($_POST['submit']))
{
 ...
 $bkd=$_POST['booking_d'];
  if(empty($spn))
	{
		$msg="Please Enter Captain's Name";
	}
	else if(empty($cln))
	{
		$msg="Please Enter Club name";
	}	
	else if(empty($cn))
	{
	...
	{
		$msg="Please Select the Venue Stadium";
	}	
	else if(empty($bkd))
	{
	...
	{
	mysql_query("insert into events(event_type,your_name,club_name,contact_no,game_name,address,booking_date) VALUES('5','$spn','$cln','$cn','$sg','$ar','$bkd')");
...
<font color="black"><input type="text" name="sname" placeholder="Captain name..." /> <br />
<font color="white">Club name<br />
<font color="black"><input type="text" name="cname" placeholder="Club name..." /> <br />
<font color="white">Contact No<br />
<font color="black"><input type="text" name="cntc" placeholder="Contact no..."/> <br />
<font color="white"><label for="area">Select Game</label><br />
    <font color="black"><select id="area" name="area1">
...
<font color="white"><label for="area">Select venue stadium</label><br />
    <font color="black"><select id="area" name="area2">
	<option value="none">Select</option>
