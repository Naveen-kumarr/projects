...
<body>
	...
	<h1><center><font color="white">MEETING VENUE</center></h1>
	<center><h4>
<?php
...
if(isset($_POST['submit']))
{
 ...
 $bkd=$_POST['booking_d'];
  if(empty($men))
	...
	{
	mysql_query("insert into events(event_type,your_name,contact_no,email_id,address,booking_date) VALUES('4','$men','$cnm','$emme','$ar','$bkd')");
...
<font color="black"><input type="text" name="mename" placeholder="Your name..." /> <br />
...
<font color="black"><input type="text" name="email_mee" placeholder="Email id..."/> <br />
<font color="white"><label for="area">Select venue</label><br />
