...
<input type="text" name="sname" placeholder="Your name..." /> <br />
Company name<br />
<input type="text" name="sname" placeholder="Company name..." /> <br />
Email<br />
<input type="text" name="email" placeholder="Email id..."/> <br />
<label for="area">Select Conference Venue</label><br />
