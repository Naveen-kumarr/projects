...
{
	 $ar1=$_POST['area1'];
	 mysql_query("insert into item_price(itemone_five,items) VALUES('$ar1','FRIED RICE')");
	 header('location:http://localhost/project/ems/guptabreakfastmenu.php');
}
 if(isset($_POST['submit2']))
{
	 $ar2=$_POST['area2'];
	 mysql_query("insert into item_price(item_threezero,items) VALUES('$ar2','FRIED RICE')");
	 header('location:http://localhost/project/ems/guptabreakfastmenu.php');
}
 if(isset($_POST['submit3']))
{
	 $ar3=$_POST['area3'];
	 mysql_query("insert into item_price(itemone_five,items) VALUES('$ar3','DOSA')");
	 header('location:http://localhost/project/ems/guptabreakfastmenu.php');
}
if(isset($_POST['submit4']))
{
	 $ar4=$_POST['area4'];
	 mysql_query("insert into item_price(item_threezero,items) VALUES('$ar4','DOSA')");
	 header('location:http://localhost/project/ems/guptabreakfastmenu.php');
}
?>
<body>
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<form action="" method="post">
                    <h1 class="page-header">BREAKFAST MENU	
</form>
                </div>
                <!-- /.col-lg-12 -->
            </div>
