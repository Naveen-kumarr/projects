...
{
	 $ar=$_POST['area'];
	mysql_query("insert into item_price(item_onefive) VALUES('$ar')");
	header('location:http://localhost/project/ems/guptamenu.php');
}
?>
<body>
    <div id="wrapper">
	...
	<center><h3><label for="area">QUANTITY</label><br /></h3>
   <select id="area" name="area">
	...
	<input type="submit" name="submit1" value="MORE ITEM" />
		<input type="submit" name="submit2" value="CHECKOUT" /></center>
